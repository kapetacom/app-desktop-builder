            ...
            <div className="plan-overview-item-wrapper">
                <svg className={"overview-item"} width="200" height="150" >
                    ...
                    <g className={classNames}>
                        <MenuItems closeMenu={() => { this.props.toggleMenu(-1) }}
                            menuItems={this.props.menuItems} visible={true} />
                    </g>
                    <foreignObject className="overview-item-menu" x={75} y={280} width={50} height={50} onClick={() => {
                ...
                <svg>
                    <SVGText className={"plan-title"} x={150} y={120} maxWidth={400} value={this.props.name} />
                    <SVGText className={"plan-version"} x={150} y={140} maxWidth={300} value={this.props.version} />
                </svg>
            </div>
        );
    }
