...
class BlockStoreItem extends React.Component<BlockStoreItemProps> {
    ...
    private renderPlaceholder = (): JSX.Element => {
        return (
            <svg className={'block-store-item-placeholder'} width={150} height={150} ref={(ref) => { this.placeholderElement = ref }}>
                <BlockNode
                    height={150}
                    width={150}
    ...
    render() {
        ...
        return (
            <DnDDrag type={'block'} value={this.props.item} copyElm={this.renderPlaceholder}>
                <div className={blockStoreItem}>
                    <div className={"store-item "}>
                        ...
                        <p className="store-item-version">{this.props.item.version}</p>
                        <div className={'store-item-icon'}><img alt={this.props.item.kind} width="16px"
                            src={"https://cdn4.iconfinder.com/data/icons/scripting-and-programming-languages/512/Python_logo-512.png"} /> </div>
                    </div>
                </div>
            </DnDDrag>
        );
